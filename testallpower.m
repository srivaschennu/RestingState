function testallpower(listname,conntype,bandidx,varargin)
...
testdata = mean(nanstd(bandpower(:,bandidx,:,:),[],4),3) * 100;
...
export_fig(gcf,sprintf('figures/crscorr_powertrend_%s.eps',bands{bandidx}));
close(gcf);
