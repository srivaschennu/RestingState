% IG 20/11/84 Plots fMRI network Balls with weights of connections
%close all
clear all

Resultsdir = fullfile('C:','Users','Ithabi','Documents','results');

load([Resultsdir filesep 'networks.mat']);
load([Resultsdir filesep 'Wcor_168_CI_N16.mat']);
load([Resultsdir filesep 'degdist.mat']);
load([Resultsdir filesep 'wtdist.mat']);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
for isubj = 1%1:length(Subj)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    
    clear vsize matrix plotqt
    %matrixVar = Wcor(1,isubj).corrected.sorted_FDR_r;
    matrixVar = Wcor(1,isubj).corrected.sorted_WFDR_r;
