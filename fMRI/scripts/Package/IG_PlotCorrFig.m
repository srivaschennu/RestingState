function IG_PlotCorrFig(Homedir,Wcor, isubj)
...
%        Image1 = Wcor(1,isubj).sorted_FDR_p;ImName1 = 'FDR_p';
 Image1 = Wcor(1,isubj).sorted_FDR_r;ImName1 = 'FDR_r';
...
%    Image1 = Wcor(1,isubj).corrected.FDR_p;ImName1 = 'Corr.FDR_p';
    ...
    figure; imagesc(Image1); title(ImName1); hold on
...
%     legend(Networks);caxis([0 1]); colorbar; caxis([0 1]); 
    ...
    saveas(gcf,[Homedir '\Figures\PropRestFDR_r\' int2str(isubj) '.jpg'])
