...
for isubj = Subj%2:length(Wcor)%[5 7 8 16 19 20 21]%[1,2,3,12,14] %
    
    pvals = Wcor(1,isubj).pVal; % Wcor(1,isubj).pVal;
    coh = Wcor(1,isubj).scale3; % coh = coherence
    ...
    Wcor(1,isubj).FDR_p = pvals;
    Wcor(1,isubj).FDR_r = coh;
end %isubj
save(WcorFile,'Wcor')